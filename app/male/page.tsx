...
export default function MaleNames() {
  ...
  return (
    <div className='flex flex-col items-center justify-center'>
      ...
      {names.map((name) => (
          <div id='card' className='flex flex-col items-center justify-center bg-black p-4 rounded-lg m-4 w-[200px] transform transition duration-300 hover:scale-105' key={name._id}>
